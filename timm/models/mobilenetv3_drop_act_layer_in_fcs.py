...
__all__ = ['MobileNetV3_DropLastAct']
...
default_cfgs = {
    ...
    'mobilenetv3_large_125': _cfg(
        interpolation='bicubic',
        url='repo/timm/models/MobileNetv3_125_pretrain.pth'),
...
class MobileNetV3_DropLastAct(nn.Module):
    """ MobiletNet-V3
    ...
    def __init__(self, block_args, num_classes=1000, in_chans=3, stem_size=16, num_features=1280, head_bias=True,
        ...
        super(MobileNetV3_DropLastAct, self).__init__()
    ...
    def as_sequential(self):
        ...
        layers.extend([self.global_pool, self.conv_head])
...
def _create_model(model_kwargs, default_cfg, pretrained=False):
    if model_kwargs.pop('features_only', False):
        ...
        load_strict = True
        model_class = MobileNetV3_DropLastAct
...
@register_model
def mobilenetv3_large_075_drop_act_layer_in_fcs(pretrained=False, **kwargs):
    """ MobileNet V3 """
...
@register_model
def mobilenetv3_small_075_drop_act_layer_in_fcs(pretrained=False, **kwargs):
    """ MobileNet V3 """
