...
from model import *
from utils import convert_model, measure_model, ProgressMeter, AverageMeter, accuracy
...
parser.add_argument('--wo_ema_weight', action='store_true', default=False,
...
def main():
    ...
    assert args.convert_from is not None, "Please give the checkpoint path of the model which is waited to be " \
